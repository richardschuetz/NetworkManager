 ...
 * @setting: the #NMSettingConnection
 *
 * Returns: the #NMSettingConnection:cardinaliy property of the connection.
 *
 * Since: 1.12
 **/
...
nm_setting_connection_get_cardinality (NMSettingConnection *setting)
{
	...
	return (NMSettingConnectionCardinality) NM_SETTING_CONNECTION_GET_PRIVATE (setting)->cardinality;
}
...
verify (NMSetting *setting, NMConnection *connection, GError **error)
{
	...
	if (!NM_IN_SET (priv->cardinality, (int) NM_SETTING_CONNECTION_CARDINALITY_DEFAULT,
	                                   (int) NM_SETTING_CONNECTION_CARDINALITY_SINGLE,
	                                   (int) NM_SETTING_CONNECTION_CARDINALITY_MANUAL_MULTIPLE,
	                                   (int) NM_SETTING_CONNECTION_CARDINALITY_MULTIPLE)) {
		g_set_error (error,
		             NM_CONNECTION_ERROR,
		             NM_CONNECTION_ERROR_INVALID_PROPERTY,
...
nm_setting_connection_class_init (NMSettingConnectionClass *setting_class)
{
	 ...
	 * moment. The values are of type #NMSettingConnectionCardinality.
	 *
